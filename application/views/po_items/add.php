            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Add PO Item</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <form action="<?= base_url('PoItems/create') ?>" method="post">
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" id="po_id" name="po_id" required>
                                            ...
                                            <option value="<?= $order['po_id'] ?>"><?= $order['po_number'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="unit_price"
                                            name="unit_price" required oninput="calculateTotal()">
                                    </div>
                                    <div class="form-group col-md-4">
